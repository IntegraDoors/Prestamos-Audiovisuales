...
if (isset($_POST['agregar'])) {
    ...
    $conn->query("INSERT INTO equipos (nombre) VALUES ('$nombre')");
...
if (isset($_POST['editar'])) {
    $id = intval($_POST['id']);
    $nombre = $conn->real_escape_string($_POST['nombre']);
    $conn->query("UPDATE equipos SET nombre='$nombre' WHERE id=$id");
    header("Location: equipos.php");
    exit;
}
...
<body class="container mt-4">
    ...
    <form method="POST" class="mb-3">
        <div class="input-group">
            <input type="text" name="nombre" class="form-control" placeholder="Nuevo equipo" required>
                ...
                <form method="POST">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="equipos.php" class="btn btn-secondary btn-sm">❌ Cancelar</a>
                        </td>
                    </tr>
                </form>
            <?php else: ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="?eliminar=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar equipo?')">🗑️ Eliminar</a>
                    </td>
                </tr>
            <?php endif; ?>
        <?php endwhile; ?>
